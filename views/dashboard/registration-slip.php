...
<div class="container d-flex justify-content-center align-content-center">
	<div class="p-5" style="background-color: #fff; width: 816px; height: 1056px;">
		<div class="container px-5">
			...
			<table class="table table-bordered table-sm mt-4">
				...
				<tbody>
					<?php session()->get('user')->admission->subjects->filter(function (Subject $subject) {
						return $subject->level === session()->get('user')->admission->level;
